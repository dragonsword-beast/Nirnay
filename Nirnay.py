...
st.markdown(
    ...
    * {{
    ...
    .stButton>div>div>button {{
        background: linear-gradient(135deg, {accent_teal} 0%, {accent_slate} 100%) !important;
        ...
        box-shadow: 0 14px 30px rgba(79, 209, 197, 0.22) !important;
    ...
    .stButton>div>button:focus-visible {{
        background: linear-gradient(135deg, {accent_teal} 0%, {accent_slate} 100%) !important;
        outline: none !important;
        box-shadow: 0 14px 30px rgba(79, 209, 197, 0.22) !important;
    }}
...
# Sidebar remains for desktop support, but the app layout is mobile-first.
st.sidebar.markdown('# 🟠Nirnay Hub')
st.sidebar.markdown(
    """
    A refined assistant for structured medical screening and system-specific analysis.

    🔬 **Remember:** This is an AI-assisted diagnostic tool. Always consult healthcare professionals for final decisions.
...
if page != "analysis":
    ...
    st.markdown(
        ...
        <div class="site-hero">
            <div class="brand-header">
                <img src="https://cdn.creativefabrica.com/2020/07/17/Medicine-Logo-Graphics-4647232-1.jpg" class="brand-logo" alt="Nirnay logo">
    ...
    st.markdown(
        ...
        <div class="summary-card">
            ...
            <ul>
                <li>Enter only confirmed patient information.</li>
                <li>Confirm the disclaimer before continuing.</li>
                <li>Tap continue to move into the analysis workflow.</li>
            </ul>
        </div>
        """,
        unsafe_allow_html=True,
...
if page == "analysis":
    ...
    st.markdown(
        ...
        <div class="topbar">
            <div class="topbar-brand">
                <img class="brand-logo" src="https://cdn.creativefabrica.com/2020/07/17/Medicine-Logo-Graphics-4647232-1.jpg" alt="Nirnay logo">
                <div>
                    <h1>NIRNAY</h1>
                    <p class="topbar-tagline">World's Hope, Health's Future</p>
                </div>
            </div>
            <div class="topbar-cta">Analysis Dashboard</div>
        </div>
    ...
    st.markdown(
        ...
        .analysis-patient-summary strong {
            color: #ffffff;
        }
        .chat-panel,
        .chat-panel-alt {
    ...
    st.markdown("<div class='chat-toggle-row'>", unsafe_allow_html=True)
    st.markdown("<div class='chat-toggle-left'>", unsafe_allow_html=True)
    st.markdown("<div class='chat-label'>Clinical Assistant(click or tap on medical chat icon</div>", unsafe_allow_html=True)
    green_clicked = st.button("👩‍⚕️ Medical Chat", key="toggle_chat_button", help="Open the clinical medical chatbot for detailed case support")
    st.markdown("</div>", unsafe_allow_html=True)

    st.markdown("<div class='chat-toggle-right'>", unsafe_allow_html=True)
    st.markdown("<div class='chat-label'>Speedy Summary</div>", unsafe_allow_html=True)
    blue_clicked = st.button("⚡ Quick Chat", key="toggle_chat_alt_button", help="Open the quick-response chatbot for short clinical answers")
    st.markdown("</div>", unsafe_allow_html=True)
    st.markdown("</div>", unsafe_allow_html=True)
    ...
    if st.session_state.chat_alt_visible:
        ...
        if send_clicked:
            if user_input and user_input.strip():
                st.session_state.chat_alt_visible = True
...
def make_inputs(container, fields):
    out = {}
    ...
    if checks:
        with container.expander("Symptoms & clinical signs", expanded=True):
